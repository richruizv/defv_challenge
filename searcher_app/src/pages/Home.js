    ...
    return <div>
          ...
          <section>
            ...
            <div>
                ...
                {this.recipes.map(function(recipe,i) {
                  return <div  className={"row"} key={i}>
                            <img title={recipe.title} src={" https://spoonacular.com/recipeImages/"+recipe.image} />
                            <p >{recipe.title}</p>
                            <p>Ready in  {recipe.readyInMinutes} minutes</p>
                            <p>{recipe.servings} servings</p>  
                            <Link to={"/detail/"+recipe.id}>Check repice</Link>
                          </div>;
                })}   
            </div>
        </section>
